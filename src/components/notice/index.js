...
const infoNotice = content => {
  return index.bind(null, infoIcon(), content, "#2196f3");
};
const errorNotice = content => {
  return index.bind(null, errorIcon(), content, "#f44336");
};
const warningNotice = content => {
  return index.bind(null, warningIcon(), content, "#ff9800");
};
const successNotice = content => {
  return index.bind(null, successIcon(), content, "#4caf50");
};
